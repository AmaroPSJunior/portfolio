...
export const DeletePhaseModal: React.FC<DeletePhaseModalProps> = ({
  phase,
  onClose,
  onConfirm,
}) => {
      ...
      >
        <div className="flex items-start justify-between border-b border-slate-800 pb-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h2 id="delete-phase-title" className="text-lg font-bold text-white">
                Excluir fase?
              </h2>
        ...
        <div className="bg-slate-950 border border-slate-800 rounded-xl p-3 text-sm text-slate-200">
          <span className="text-emerald-400 font-semibold">Fase {phase.id}:</span>{' '}
          {phase.title}
        </div>
